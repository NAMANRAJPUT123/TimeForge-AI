        ...
        async () => {
          try {
            ...
            const recEvent = {
              ...
              description: `Focus Block created automatically by Deadline Guardian AI.\n\nInstruction: "${recText}"\nAssociated Task: "${name}"\n\nRemain accountable!`,
